...
export default function HandlingFireyClients() {
    return (
        <Layout title="Handling Fiery Clients">
                ...
                <article>
                        ...
                        <div class="absolute h-full w-full flex flex-col items-center justify-center text-gray-800">
                            <div class="opacity-80 p-8 rounded-lg bg-yellow-50 z-10">
                                <div class="text-center mb-1 lg:mb-2">
                                    ...
                                    <span class="mx-2 lg:mx-3 font-medium">
                                        August 20, 2021
                                    </span>
                                </div>
                    ...
                    <div class="max-w-prose mx-6 lg:mx-auto text-gray-600">
                        <p class="mb-12 text-lg lg:text-xl font-semibold text-gray-700">
                            ...
                            elit. Possimus eligendi libero sit nihil tempora,
                            totam reprehenderit aliquam beatae obcaecati
                            ratione. Libero consequatur cumque magnam ipsam quae
                            sequi laudantium pariatur veritatis? Totam
                            reprehenderit aliquame.
                        </p>
                        <p class="mb-4">
