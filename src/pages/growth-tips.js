                        ...
                        <div className="flex flex-col-reverse md:grid md:grid-cols-5">
                            <div className="flex min-h-0 flex-col col-start-1 col-end-3 md:mr-6">
                                ...
                                <p className="text-sm mb-6 flex-grow text-gray-600">
                                    ...
                                    adipisicing elit. Possimus eligendi libero
                                    sit nihil tempora, totam reprehenderit
                                    aliquam beatae obcaecati ratione. Libero
                                    consequatur cumque magnam ipsam quae sequi
                                    laudantium pariatur veritatis?
                                </p>
                            ...
                            >
                                ...
                                <div className="flex flex-col ">
                                    ...
                                    <p className="text-sm mb-6 flex-grow text-gray-600">
                                        ...
                                        ratione. Libero consequatur cumque
                                        magnam ipsam quae sequi laudantium
                                        pariatur veritatis?{" "}
                                    </p>
                                    <div className="flex items-center">
                                        <div className="h-12 w-12 rounded-md overflow-hidden flex-shrink-0">
